...
<html>
	<head>
		...
		<title>myCenter NotpassRules</title>
		...
		<div class="container-fluid">
			<div class="row">
				<div id="header" class="col-sm-12">
					<h3 class="my-title"><span class="glyphicon glyphicon-remove-sign text-primary"></span> 未通过规则</h3>
				</div>
			</div>
			...
			<div class="row">
				<div class="col-md-12">
					<table class="table table-bordered table-striped">
						...
						<tbody>
							<c:forEach items="${myNotpassRule}" var="rule">
							<tr>
								<td>${rule.id }</td>
								<td>
