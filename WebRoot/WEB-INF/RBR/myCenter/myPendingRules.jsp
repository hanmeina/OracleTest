...
<html>
	<head>
		...
		<title>myCenter pendingRules</title>
		...
		<div class="container-fluid">
			<div class="row">
				<div id="header" class="col-sm-12">
					<h3 class="my-title"><span class="glyphicon glyphicon-time text-primary"></span> 待审核规则</h3>
				</div>
			</div>
			...
			<div class="row">
				<div class="col-md-12">
					<table class="table table-bordered table-striped">
						...
						<tbody>
							<c:forEach items="${myPendingRule}" var="rule">
							<tr>
								<td>${rule.id }</td>
								<td>
