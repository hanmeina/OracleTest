			...
			<div class="row">
				<div class="col-xs-12 text-right buttons-area">
					<a class="btn btn-default clear-all"
						href="reasoning/selectQualityCondition.action" role="button">清空</a>
					<input type="hidden" name="idstr" value=""/>
					<input id="text2" type="hidden" name="fastOrAllRule" value="0"/>
					<button id="btn2" class="btn btn-primary ok">高级推理</button>
				</div>
			</div>
		</form>
