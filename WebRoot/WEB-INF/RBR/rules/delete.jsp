		...
		<div class="container-fluid">
			<div class="row">
				<div id="header" class="col-sm-12">
					<h3 class="my-title"><span class="glyphicon glyphicon-trash text-primary"></span> 删除规则</h3>
				</div>
			</div>
				...
				<div class="col-md-12">
					<table class="table table-bordered table-striped">
						...
						<!--		<a href="metaData/${metaData.id }/deleteWarning">${metaData.name }</a> -->
								<td><a href="rules/deleteConfirm.action?id=${rule.id }" class="btn btn-primary">删除</a>
							</tr>
							</c:forEach>
						</tbody>
					</table>
