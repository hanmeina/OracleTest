...
function checkName(i){
  ...
  <body>
	...
	<div >
	<center>添加角色</center><br><br>
	<form class="form-horizontal" role="form" action="Role/addRole.action" method="post">
  <div class="form-group">
    <label class="col-sm-2 control-label">角色名：</label>
    <div class="col-sm-6">
      <input type="text" class="form-control" name="rolename" onchange="checkName(this)" pattern="[\u4e00-\u9fa5]{1,10}" placeholder="角色名由小于10位的汉字组成！" required autofocus>
    </div>
  </div>
